...
class Scene():
    # todo it would be better to just extend pview...
    ...
    def pass_through_ext(self, action):
        extensions_ = self.data_dict['scene']['extensions']
        ...
        for ext in extensions:
            ...
            ext.invoke(self, self.data_dict, action)
    ...
    def debug(self, frustum=True, light_pos=True, buffers=False):
        # todo could probably just be generic util; traverse nodes
